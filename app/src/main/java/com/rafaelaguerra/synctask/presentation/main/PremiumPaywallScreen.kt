...
fun PremiumPaywallScreen(
    ...
    val reasonText = when (reason) {
        PaywallReason.WEEKLY_LIMIT -> stringResource(R.string.paywall_reason_weekly_limit)
        PaywallReason.EDIT_EXISTING_EVENT -> stringResource(R.string.paywall_reason_edit_existing)
        null -> stringResource(R.string.paywall_reason_default)
    }
        ...
        Card(
            ...
            Column(
                ...
                Box(
                    ...
                    Text(stringResource(R.string.paywall_icon))
                }
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.paywall_one_time_payment),
                        ...
                        Text(
                            text = stringResource(R.string.paywall_benefits_summary),
                ...
                CalmPrimaryButton(
                    text = if (isPurchaseInProgress) {
                        ...
                        stringResource(R.string.paywall_cta_unlock)
                    },
                ...
                CalmSecondaryButton(
                    text = stringResource(R.string.paywall_cta_continue_free),
